...
export default function SidebarAddItemDiscount() {
    ...
    <aside className={`${openSidebarAdd ? 'w-[400px] p-6 h-auto' : 'w-[0px] p-0 h-0'} relative z-40 bg-cust-gray block transition-all overflow-x-hidden`}>
      ...
      <div>
        ...
        <div className="mb-5">
          ...
          <div className="mt-2">
            <select onChange={(e) => { setDiscountType(e.target.value) }} type="text" name="discount_type" id="discount_type" className="block w-full bg-cust-bg-gray border-0 py-2.5 px-3 ring-1 ring-inset ring-gray-400/70 placeholder:text-gray-500/75 focus:ring-2 focus:outline-none focus:border-none focus:ring-inset focus:ring-cust-yellow sm:text-sm sm:leading-6">
        ...
        <div className="mb-5">
          <label htmlFor="item Name" className="block text-sm text-cust-gray-darker">Discount {discountType}</label>
          <div className="mt-2">
            <input type="number" name="item Name" id="item Name" className="block w-full bg-cust-bg-gray border-0 py-1.5 px-3 ring-1 ring-inset ring-gray-400/70 placeholder:text-gray-500/75 focus:ring-2 focus:outline-none focus:border-none focus:ring-inset focus:ring-cust-yellow sm:text-sm sm:leading-6" placeholder="e.g: Dark Chocolate" />
          </div>
        </div>
      </div>
