...
import SidebarAddItemCategory from "../../components/Library/SidebarAddCategory";
            ...
            <div className="flex justify-between">
              <header>
                ...
                <p className="text-cust-gray-darker">
                  Here, you can create your outlet category and view the list.
                </p>
              </header>
