...
import SidebarAddItemSalesType from "../../components/Library/SidebarAddSalesType";
          ...
          <section className="mt-8">
            <div className="flex justify-between">
              <header>
                ...
                Here, you can create your outlet Sales Type and view the list.
                </p>
              </header>
