...
import SidebarAddItemDiscount from "../../components/Library/SidebarAddDiscount";
          ...
          <section className="mt-8">
            <div className="flex justify-between">
              <header>
                ...
                Here, you can create your outlet discount and view the list.
                </p>
              </header>
